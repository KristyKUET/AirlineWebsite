		...
		<body>	
                    <div class="section-top-border">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <input type="text" name="sch_id" placeholder="Schedule Id" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Journy Id'" required class="single-input">
                            </div><br>
                            <div class="mt-10">
                            <h4>Journey ID:</h4><br>    
                            ...
                            <input type="text" name="deptime" placeholder="Departure Time" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Departure Time'" required class="single-input">
                            </div>
                            <div class="mt-10">
                            <h4>Arrival Time:</h4><br>      
                            <input type="text" name="arritime" placeholder="Arrival Date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Arrival Time'" required class="single-input">
                            </div>
                            <br>
               ...
               if($_GET["submit"])
               {
                ...
                if($s !="" && $j !="" && $d !="" && $t !="" && $a !="")
                {
                    $sql = "INSERT INTO  schedule(sch_id,journ_id,Depdate,Deptime,arritime)   VALUES ('$s','$j','$d','$t','$a')";
