...
#reg
{
	...
	<head>
		...
		<body id="back">	
                ...
                <h3 class="mb-30">Register Your Account Within a Minute</h3>
                <form action="reg_back.php" method="post" style="background-color:#FDF5E6;padding:25px">
                    <div class="mt-10">
                    ...
                    <div class="mt-10">
                    <input type="text" name="nationality" placeholder="Nationality" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nationality'" required class="single-input">
					</div>
